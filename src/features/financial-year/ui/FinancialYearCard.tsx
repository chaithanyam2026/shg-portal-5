...
export default function FinancialYearCard({ financialYear }: FinancialYearCardProps) {
  return (
    <Card variant="outlined">
      <Link href={`/financial-years/${financialYear._id}`} style={{ textDecoration: "none" }}>
        <CardActionArea>
          <CardContent>
            <Stack spacing={2}>
              <Stack
              ...
              <Stack spacing={0.5}>
                ...
                <Typography variant="body1">
                  {format(new Date(financialYear.startDate), "dd MMM yyyy")}
                </Typography>
              </Stack>
              ...
              <Stack spacing={0.5}>
                ...
                <Typography variant="body1">
                  {format(new Date(financialYear.endDate), "dd MMM yyyy")}
                </Typography>
              </Stack>
