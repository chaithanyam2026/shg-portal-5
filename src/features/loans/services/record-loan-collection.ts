...
export async function recordLoanCollection(
  loanId: string,
  input: RecordLoanCollectionInput,
) {
  await connectMongo();
  ...
  // TODO:
  // Create a LoanTransaction / LoanPassbook entry here.
  // Outstanding balances should be calculated from the ledger.
