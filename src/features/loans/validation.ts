 ...
 */
export const LoanTypeSchema =
  z.enum(LOAN_TYPES);

/**
 * Loan Status validation.
 */
export const LoanStatusSchema =
  z.enum(LOAN_STATUS);
    ...
    .object({
      ...
      expectedMonthlyRepayment:
        z
          ...
          .number()
          .positive(
            "Minimum monthly repayment must be greater than zero.",
          ),
...
export const UpdateLoanSchema =
  z
    .object({
      loanType:
        LoanTypeSchema.optional(),

      status:
        LoanStatusSchema.optional(),
      ...
      (
        ...
        if (
          ...
          context.addIssue({
            ...
            message:
              "Minimum monthly repayment cannot exceed the disbursed amount.",
          });
        }
      },
    );
