...
const TRANSACTION_ORDER: Record<string, number> = {
  ...
  [LEDGER_TRANSACTION_TYPE.MEETING_INCOME_TOTAL]: 6,
  [LEDGER_TRANSACTION_TYPE.BANK_WITHDRAWAL]: 7,
  [LEDGER_TRANSACTION_TYPE.BANK_DEPOSIT]: 8,
  [LEDGER_TRANSACTION_TYPE.OTHER_EXPENSE]: 9,
  [LEDGER_TRANSACTION_TYPE.LOAN_DISBURSEMENT]: 10,
};
