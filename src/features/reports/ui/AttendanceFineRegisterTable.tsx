...
export default function AttendanceFineRegisterTable({ register }: Props) {
  return (
          ...
          {register.rows.length === 0 ? (
            <TableRow>
              <TableCell colSpan={9} align="center">
                <Typography color="text.secondary">No attendance fine records found.</Typography>
              </TableCell>
            </TableRow>
          ) : (
