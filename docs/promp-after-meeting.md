...
Prepare a income - expense report page based on meeting transaction. The amount collected is summed as the cash in hand, and once its invested to bank or taken for some expenses, then subtract this from cach in hand. The bank balance will increate once the amount is invested. Once cach is withdrawed, it will move to cach in hand and the amount is increased.

Create this as a tabular view group by month with below columns
1. Date
2. Transaction type 
    - Income - conttribution payment, fine payement, loan repayment, other income, Bank withdraw
    - Expense - Bank investment, Other expenses, loan disbursement
3. Income amount - this is for income amount
4. Expense amount - this is for expense amount
5. Cash in hand - total cash in hand
6. Banl balance